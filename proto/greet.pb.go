...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xdd, 0x02, 0x0a, 0x0c,
...
var file_proto_greet_proto_goTypes = []interface{}{
	...
	(*NamesList)(nil),     // 1: greet_service.NamesList
	(*MessagesList)(nil),  // 2: greet_service.MessagesList
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	1, // 1: greet_service.GreetService.SayHelloServerStreaming:input_type -> greet_service.NamesList
	...
	2, // 6: greet_service.GreetService.SayHelloClientStreaming:output_type -> greet_service.MessagesList
